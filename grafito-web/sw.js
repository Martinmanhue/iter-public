const SHELL_CACHE='grafito-shell-v9';
const RUNTIME_CACHE='grafito-runtime-v9';
const SHELL=['./','./index.html','./style.css?v=9','./grafito-v7.js?v=9-base','./grafito-v9-patch.js?v=9-hybrid','./manifest.webmanifest'];
