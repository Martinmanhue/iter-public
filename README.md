...
[Ver la vista previa](ITER_PREVIEW.md) · [Consultar la hoja de ruta](ROADMAP.md) · [Mensajes para compartir](SHARE_ITER.md) · [Kit de presentación](PRESS_KIT.md)
...
5. Revisa el [kit de presentación](PRESS_KIT.md) para una explicación breve y reutilizable.
6. Responde al issue [¿Qué debería unificar Iter primero?](https://github.com/Martinmanhue/iter-public/issues/1).
